...
class Sidebar(tk.Frame):
    ...
    def on_import(self):  # Modified method
...
class Main(ttk.Frame):
    ...
    def create_treeview(self, parent):
        ...
        treeview.heading("Task Name", text="Task Name", anchor=tk.W)
        treeview.heading("Priority", text="Priority", anchor=tk.W)
        treeview.heading("Due date", text="Due date", anchor=tk.W)
